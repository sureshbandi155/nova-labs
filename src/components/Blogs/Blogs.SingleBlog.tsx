     ...
     <Layout>
        <Grid>
            <Grid.Column mobile={16} tablet={8}>
                <div className={['wrapperBlog', styles['singleBlog']].join(' ')}>
                    <p><time>October 4, 2021</time>
                        <Label >Blockchain</Label></p><h1>A primer on blockchain and its value beyond cryptocurrencies</h1>
                    ...
                    <img alt="" src="https://images.prismic.io/byont-website/109c66b1-ca61-44a9-afda-8cff7603954b_04.png?auto=compress,format&amp;rect=0,0,1280,720&amp;w=512&amp;h=288" sizes="100vw" decoding="async" width="1200" height="700"></img>
                    <div>
                        ...
                        <img alt="Top 25 most funded industries in blockchain / crypto according to BlockData." src="https://images.prismic.io/byont-website/dd9d0e03-d005-436e-ab78-7c240e1ebc84_top-25-most-funded-industries-in-blockchain-crypto.webp?auto=compress,format&amp;rect=1,0,1919,1279&amp;w=1200&amp;h=800" sizes="100vw" decoding="async" width="1200" height="800" ></img>
